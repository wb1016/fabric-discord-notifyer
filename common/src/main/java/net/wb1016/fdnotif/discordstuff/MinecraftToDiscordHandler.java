...
import net.wb1016.fdnotif.api.discord.handlers.CommandHandler;
import net.wb1016.fdnotif.api.discord.handlers.StringHandler;
import net.wb1016.fdnotif.api.discord.handlers.TextHandler;
...
//                        }
    ...
    public MinecraftMessage handleText(Message text) {
        ...
        for (net.wb1016.fdnotif.api.discord.handlers.MessageHandler messageHandler : TEXT_HANDLERS) {
