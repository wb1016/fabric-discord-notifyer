...
import net.wb1016.fdnotif.api.config.MainConfig;
...
import net.wb1016.fdnotif.api.minecraft.VersionHelper;
import net.wb1016.fdnotif.api.minecraft.style.ClickEvent;
import net.wb1016.fdnotif.api.minecraft.style.Style;
import net.wb1016.fdnotif.discord.Commands;
...
//            LOGGER.error("[fdnotif] Please add either a game chat or a log channel to the config file (or both)!");
//            return;
//        }
...
//                        }
            ...
            fdnotif.MESSAGE_LOGGER.info(this.lastMessageD);
    ...
    @Override
    public void sendMessage(net.wb1016.fdnotif.api.minecraft.Message message) {
